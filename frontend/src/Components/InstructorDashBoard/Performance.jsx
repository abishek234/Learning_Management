...
const StudentPerformance = () => {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      if (userId) {
        try {
          const response = await axios.get(`http://localhost:7000/api/courses/instructor/${userId}`);
        ...
        <main>
          <div className="performance-container" style={{ marginTop: '70px' }}>
            <div style={{ marginBottom: '80px' }}>
              ...
              <h2 style={{ color: 'darkblue', marginTop: '20px' }}>Performance Chart</h2>
